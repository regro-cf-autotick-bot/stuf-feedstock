...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/stuf-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/stuf-feedstock)
...
Once the `conda-forge` channel has been enabled, `stuf` can be installed with:

```
conda install stuf
```

It is possible to list all of the versions of `stuf` available on your platform with:
